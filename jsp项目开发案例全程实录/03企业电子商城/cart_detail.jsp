      ...
      for(int orderNumber=0;orderNumber<orderList.size();orderNumber++){
        ...
        %>
          <tr align="center">
            ...
            <td><%
            if(orderForm.getTel()==null||orderForm.getTel().equals(""))
            {
            	out.println("&nbsp;");
            }else{
            	out.println(orderForm.getTel());
            }
            %></td>
            <td><%
            if(orderForm.getAddress()==null||orderForm.getAddress().equals(""))
            {
            	out.println("&nbsp;");
            }else{
            	out.println(orderForm.getAddress());
            }
            %></td>
